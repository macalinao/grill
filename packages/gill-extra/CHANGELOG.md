...
- Updated dependencies [60965e2]
  - @macalinao/solana-batch-accounts-loader@0.4.1
  - @macalinao/solana-errors@0.4.0
...
- Updated dependencies [548a2d6]
  - @macalinao/solana-batch-accounts-loader@0.4.0
  - @macalinao/solana-errors@0.3.0
...
- 3d44354: Add an optional `latestBlockhash` to the transaction send options. When provided, `sendTX` builds the transaction with the supplied blockhash instead of fetching a fresh one via `rpc.getLatestBlockhash()`, letting callers who maintain their own up-to-date blockhash skip an RPC round trip per transaction.
