...
import { getPrimaryStakeAccounts } from "./claim-primary-rewards.js";

/**
 * Creates instructions to claim rewards for a primary miner without withdrawing.
 * This is a permissionless function for cases where the claimer does not have authority over the merge miner.
 */
export async function claimPrimaryRewardsNoWithdraw({
  mergePool,
  mmOwner,
  payer,
  rewarder,
